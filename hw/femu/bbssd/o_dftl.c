...
void dftl_static(struct ssd* ssd) {
    femu_log("[DFTL]access_cnt: %lu, cmt_hit_cnt: %lu, cmt_miss_cnt: %lu, cmt_hit_ratio: %f\n",
                ssd->stat.access_cnt, ssd->stat.cmt_hit_cnt, ssd->stat.cmt_miss_cnt, ssd->stat.cmt_hit_ratio);
}