    ...
    if (wpp->ch == spp->nchs) {
        ...
        if (wpp->lun == spp->luns_per_ch) {
            ...
            if (wpp->pg == spp->pgs_per_blk) {
                ...
                // 超级块写满了
                femu_log("当前的超级块id:%d,  cur_line_vpc: %d, cur_line_ipc: %d\n", wpp->curline->id,  
                ...
                femu_log("获取的超级块id:%d,  lm.full_cnt: %d, lm.vim_cnt: %d, lm.free_cnt: %d\n", wpp->curline->id,  
